  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.data && err.response.data.error) {
        setError(err.response.data.error); // Error from the backend
      } else {
